<?php
    ...
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $query = "SELECT * FROM oficiales WHERE id = '$id';";
    ...
    if (isset($_POST['update'])) {
        ...
        if (mysqli_affected_rows($con) == 1) { 
            echo "<script>alert('Oficial Actualizado');</script>";
			echo "<script>location.assign(\"../select/SOficiales.php\")</script>";
        }
        cerrar($con);
    }
...
<body>
        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="#" class="nav-link px-2 text-white" style="font-size: 30px;">Actualizar Oficiales</a>
                    </li>
                </ul>
                <div class="text-end">
    ...
    <div class="p-5 m-0 border-0">
        <form method="post" action="UOficiales.php?id=<?php echo $_GET['id'] ?>">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                ...
                <input class="form-control border border-2" type="text" id="grupo" name="grupo" minlength="1" maxlength="50" value="<?php echo $grupo ?>">
            </div>
            <div class="col-md-2">
                <label class="form-label">firma</label>
                <input class="form-control border border-2" type="text" id="firma" name="firma" minlength="1" maxlength="100" value="<?php echo $firma ?>">
            </div>
